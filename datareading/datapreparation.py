...
SOURCE_CODE_METRICS_FILE = PROJECT_LOCATION + ""
REPO_MINING_FILE = PROJECT_LOCATION + ""
USAGE_DATA_FOLDER = PROJECT_LOCATION + ""

REPO_MINING_FILE_FOR_CHGLINES = PROJECT_LOCATION + ""

TEST_COVERAGE_FILE = None

SAVE_TO_FOLDER = PROJECT_LOCATION + "output/"
...
if __name__ == "__main__":
    ...
    if save:
        merged.to_csv(SAVE_TO_FOLDER + "metrics.csv", sep=';', index=False)
